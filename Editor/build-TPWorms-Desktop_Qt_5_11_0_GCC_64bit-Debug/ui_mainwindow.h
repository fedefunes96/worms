...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(845, 540);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(310, 20, 171, 71));
        ...
        menuWorms_Editor = new QMenu(menuBar);
        menuWorms_Editor->setObjectName(QStringLiteral("menuWorms_Editor"));
        ...
        menuBar->addAction(menuWorms_Editor->menuAction());

...
#include "../Game_worms/projectile.h"
...
QT_MOC_LITERAL(1, 11, 14), // "nextFameImpact"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Projectile\0nextFameImpact\0"
};
...
void *Projectile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Projectile*>(this));
